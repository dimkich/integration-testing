...
@Component
public class IncrCommandHandler implements RedisStreamHandler<IncrCommand> {
    @Override
    public boolean canHandle(Class<? extends Event> eventClass) {
        return eventClass == IncrCommand.class;
    }

    @Override
    public void handle(IncrCommand event, RedisInMemoryStore store) {
