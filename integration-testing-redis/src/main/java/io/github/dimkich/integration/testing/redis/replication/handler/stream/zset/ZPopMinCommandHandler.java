...
@Component
public class ZPopMinCommandHandler implements RedisStreamHandler<ZPopMinCommand> {
    @Override
    public boolean canHandle(Class<? extends Event> eventClass) {
        return eventClass == ZPopMinCommand.class;
    }

    @Override
    public void handle(ZPopMinCommand event, RedisInMemoryStore store) {
