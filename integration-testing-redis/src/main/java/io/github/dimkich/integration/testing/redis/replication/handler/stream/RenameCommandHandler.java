...
@Component
public class RenameCommandHandler implements RedisStreamHandler<RenameCommand> {
    @Override
    public boolean canHandle(Class<? extends Event> eventClass) {
        return eventClass == RenameCommand.class;
    }

    @Override
    public void handle(RenameCommand event, RedisInMemoryStore store) {
